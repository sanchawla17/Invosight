     ...
     <div className="min-h-screen bg-white flex items-center justify-center px-4 py-8">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          <div className="w-12 h-12 bg-gradient-to-r from-emerald-950 to-emerald-900 rounded-xl mx-auto mb-6 flex items-center justify-center">
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-emerald-950 to-emerald-900 text-white py-3 px-4 rounded-lg font-medium hover:bg-gray-800 disabled:bg-gray-300 disabled:cursor-not-allowed transition-colors flex items-center justify-center group"
          >
            {isLoading ? (
              <>
